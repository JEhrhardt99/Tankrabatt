...
df_stations <- fread("../Data/Tankerkoenig/stations/2021/01/2021-01-01-stations.csv")
...
# price data for 2023-07-12
df_2023_test <- fread("../Data/Tankerkoenig/prices/2023/07/2023-07-12-prices.csv")

# load station data for the corresponding day to learn more
df_stations2023_test <- fread("../Data/Tankerkoenig/stations/2023/07/2023-07-12-stations.csv")

# correct time zone
df_2023_test$date <- as.POSIXct(df_2023_test$date,
                      format = "%Y-%m-%d %H:%M:%S%z",
                      tz = "Europe/Berlin")

# subset the weird observations
weird_obs_test <- df_2023_test %>% filter(diesel == -0.001 |
                             e10 == -0.001)
...
# subset the stations with the weird observations
weird_stations_test <- df_stations2023_test %>%
...
# XML-Datei einlesen
xml_data <- read_xml("../Data/Prix-des-carburants/2021/PrixCarburants_annuel_2021.xml")
